...
function DashboardContent() {
  ...
  const partnerName = user?.nombrePareja || (isNovio ? "Diana" : "Samuel");
  const userName = user?.nombre || (isNovio ? "Samuel" : "Diana");
            ...
            {isDemoAccount && (
              <>
                ...
                >
                  ...
                  <span>Ver como {partnerName}</span>
                </button>
              </>
            )}
          </div>
